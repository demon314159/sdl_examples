...
Toy::Toy()
    ...
    , m_pole1({-W1 / 8.0, 0.0, L1 / 2.0}, POLE_RADIUS, POLE_HEIGHT, POLE_REFLECTIVITY)
    , m_pole2({W1 / 8.0, 0.0, L1 / 2.0}, POLE_RADIUS, POLE_HEIGHT, POLE_REFLECTIVITY)
    , m_pole3({0.0, 0.0, 3.0f * L1 / 4.0}, POLE_RADIUS, POLE_HEIGHT, POLE_REFLECTIVITY)
{
    build_model();
