...
Toy::Toy()
    ...
    , m_wall1(0.0, {0.0, 0.0, 0.0}, WALL1_LENGTH, WALL_RADIUS, WALL_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, WALL_REFLECTIVITY, WALL_SEGMENTS)
    , m_wall2(-90, {(-W1 / 2.0 - W2 / 2.0) / 2.0, 0.0, L1 / 2.0}, WALL2_LENGTH, WALL_RADIUS, WALL_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, WALL_REFLECTIVITY, WALL_SEGMENTS)
    , m_wall3(90.0, {(W1 / 2.0 + W2 / 2.0) / 2.0, 0.0, L1 / 2.0}, WALL3_LENGTH, WALL_RADIUS, WALL_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, WALL_REFLECTIVITY, WALL_SEGMENTS)
    , m_wall4(THETA4, {(-W2 / 2.0 - W3 / 2.0) / 2.0, 0.0, L1 + L2 / 2.0}, WALL4_LENGTH, WALL_RADIUS, WALL_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, WALL_REFLECTIVITY, WALL_SEGMENTS)
    , m_wall5(THETA5, {(W2 / 2.0 + W3 / 2.0) / 2.0, 0.0, L1 + L2 / 2.0}, WALL5_LENGTH, WALL_RADIUS, WALL_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, WALL_REFLECTIVITY, WALL_SEGMENTS)
    ...
    , m_pole1({-W1 / 8.0, 0.0, L1 / 2.0}, POLE_RADIUS, POLE_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, POLE_REFLECTIVITY, POLE_SEGMENTS)
    , m_pole2({W1 / 8.0, 0.0, L1 / 2.0}, POLE_RADIUS, POLE_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, POLE_REFLECTIVITY, POLE_SEGMENTS)
    , m_pole3({0.0, 0.0, 3.0f * L1 / 4.0}, POLE_RADIUS, POLE_HEIGHT, BUMPER_THICKNESS, BUMPER_HEIGHT, BODY_COLOR, BUMPER_COLOR, POLE_REFLECTIVITY, POLE_SEGMENTS)
{
    build_model();
