...
void PuzzleBook::add_challenges()
{
    ...
    add_challenge(Challenge(10, 6).p(1, 0, 0, 0).p(1, 1, 1, 0).p(10).p(11, 0, 1, 2).p(16).p(19).p(24).p(25).p(38).p(29, 3, 9, 0)); // 20
    ...
    add_challenge(Challenge(10, 6).p(1, 0, 0, 0).p(1, 1, 2, 0).p(5).p(8).p(36).p(16).p(22, 4, 6, 1).p(27).p(29).p(31)); // 23
    ...
    add_challenge(Challenge(10, 6).p(1, 0, 0, 0).p(12).p(4).p(10).p(11).p(1).p(13).p(26).p(27, 3, 7, 3).p(29)); // 27
    add_challenge(Challenge(10, 6).p(1, 0, 0, 0).p(11).p(6).p(8).p(10).p(1).p(12, 1, 4, 3).p(15).p(17).p(19)); // 28
