...
// Calculate vertex position in screen space
    if (a_animation_id < 0.5) { // Optimize this most common case
        ...
        if (a_animation_id < 1.5) {              // Light
            ...
            v_color = vec4(a_color, 1.0);
        } else if (a_animation_id < 6.5) {       // Animated objects
            ...
            } else if (a_animation_id < 5.5) {   // Ball
            ...
            v_normal = rot_matrix * vec4(billy, 0.0);
            v_color = vec4(a_color, 1.0);
        } else if (a_animation_id < 42.5) { // 21 Lamps
            if (a_animation_id < 22.5) {         // Lamp1
                v_color = vec4(lamp_color[0], 1.0);
            } else if (a_animation_id < 23.5) {  // Lamp2
                v_color = vec4(lamp_color[1], 1.0);
            } else if (a_animation_id < 24.5) {  // Lamp3
                v_color = vec4(lamp_color[2], 1.0);
            } else if (a_animation_id < 25.5) {  // Lamp4
                v_color = vec4(lamp_color[3], 1.0);
            } else if (a_animation_id < 26.5) {  // Lamp5
                v_color = vec4(lamp_color[4], 1.0);
            } else if (a_animation_id < 27.5) {  // Lamp6
                v_color = vec4(lamp_color[5], 1.0);
            } else if (a_animation_id < 28.5) {  // Lamp7
                v_color = vec4(lamp_color[6], 1.0);
            } else if (a_animation_id < 29.5) {  // Lamp8
                v_color = vec4(lamp_color[7], 1.0);
            } else if (a_animation_id < 30.5) {  // Lamp9
                v_color = vec4(lamp_color[8], 1.0);
            } else if (a_animation_id < 31.5) {  // Lamp10
                v_color = vec4(lamp_color[9], 1.0);
            } else if (a_animation_id < 32.5) {  // Lamp11
                v_color = vec4(lamp_color[10], 1.0);
            } else if (a_animation_id < 33.5) {  // Lamp12
                v_color = vec4(lamp_color[11], 1.0);
            } else if (a_animation_id < 34.5) {  // Lamp13
                v_color = vec4(lamp_color[12], 1.0);
            } else if (a_animation_id < 35.5) {  // Lamp14
                v_color = vec4(lamp_color[13], 1.0);
            } else if (a_animation_id < 36.5) {  // Lamp15
                v_color = vec4(lamp_color[14], 1.0);
            } else if (a_animation_id < 37.5) {  // Lamp16
                v_color = vec4(lamp_color[15], 1.0);
            } else if (a_animation_id < 38.5) {  // Lamp17
                v_color = vec4(lamp_color[16], 1.0);
            } else if (a_animation_id < 39.5) {  // Lamp18
                v_color = vec4(lamp_color[17], 1.0);
            } else if (a_animation_id < 40.5) {  // Lamp19
                v_color = vec4(lamp_color[18], 1.0);
            } else if (a_animation_id < 41.5) {  // Lamp20
            ...
            gl_Position = mvp_matrix * vec4(a_position, 1.0);
            v_normal = vec4(0.0, 0.0, 1.0, 0.0);
        } else if (a_animation_id < 51.5) { // 9 Scoreboard Lamps
            if (a_animation_id < 43.5) {         // Lamp22 (Scoreboard)
                v_color = vec4(lamp_color[21], 1.0);
            } else if (a_animation_id < 44.5) {  // Lamp23 (Scoreboard)
                v_color = vec4(lamp_color[22], 1.0);
            } else if (a_animation_id < 45.5) {  // Lamp24 (Scoreboard)
                v_color = vec4(lamp_color[23], 1.0);
            } else if (a_animation_id < 46.5) {  // Lamp25 (Scoreboard)
                v_color = vec4(lamp_color[24], 1.0);
            } else if (a_animation_id < 47.5) {  // Lamp26 (Scoreboard)
                v_color = vec4(lamp_color[25], 1.0);
            } else if (a_animation_id < 48.5) {  // Lamp27 (Scoreboard)
                v_color = vec4(lamp_color[26], 1.0);
            } else if (a_animation_id < 49.5) {  // Lamp28 (Scoreboard)
                v_color = vec4(lamp_color[27], 1.0);
            } else if (a_animation_id < 50.5) {  // Lamp29 (Scoreboard)
            ...
            v_normal = vec4(0.0, 0.0, 1.0, 0.0);
        } else if (a_animation_id < 80.5) {      // Scoreboard
            gl_Position = scoreboard_mvp_matrix * vec4(a_position, 1.0);
