...
StraightWireGuide::StraightWireGuide(float angle, Float3 position, float length, float height, float diameter,
...
float StraightWireGuide::angle() const
{
    return m_angle;
}

Float3 StraightWireGuide::position() const
{
    return m_position;
}

float StraightWireGuide::length() const
{
    return m_length;
}

float StraightWireGuide::height() const
{
    return m_height;
}

float StraightWireGuide::diameter() const
{
    return m_diameter;
}
