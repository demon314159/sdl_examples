    ...
    , m_flat_rail(NULL)
{
    ...
    m_flat_rail = new FlatRail({X6, 0.2286}, FLAT_RAIL_LENGTH, FLAT_RAIL_WIDTH, FLAT_RAIL_THICKNESS, FLAT_RAIL_BEND_RADIUS, Y1, FLAT_RAIL_COLOR, FLAT_RAIL_REFLECTIVITY, FLAT_RAIL_SEGMENTS);
}
