    ...
    , m_three_post1(NULL)
{
    ...
    m_wire_guide7 = new StraightWireGuide(-29.4537, position7, length7, 0.5 * WIRE_GUIDE_DIAMETER, WIRE_GUIDE_DIAMETER, WIRE_GUIDE_COLOR, WIRE_GUIDE_REFLECTIVITY, WIRE_GUIDE_SEGMENTS);
