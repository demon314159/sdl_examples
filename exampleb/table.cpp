    ...
    , m_flat_rail(NULL)
{
    ...
    m_flat_rail = new FlatRail({X6, 0.22825}, FLAT_RAIL_LENGTH, FLAT_RAIL_WIDTH, FLAT_RAIL_THICKNESS, FLAT_RAIL_BEND_RADIUS, 2.0 * BALL_RADIUS, FLAT_RAIL_COLOR, FLAT_RAIL_REFLECTIVITY, FLAT_RAIL_SEGMENTS);
}
