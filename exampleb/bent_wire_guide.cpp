...
BentWireGuide::BentWireGuide(float angle, Float3 position, float length, float height, float diameter,
...
BentWireGuide::~BentWireGuide()
{
}

void BentWireGuide::collide(Ball* ball) const
{
...
CadModel BentWireGuide::model(float animation_id) const
{
    CadModel mm;
