...
RingShape::RingShape(float radius_o, float radius_i, float height, int steps, float upper_bevel_o, float upper_bevel_i, float lower_bevel_o, float lower_bevel_i)
    : m_radius_o(radius_o)
    , m_radius_i(radius_i)
    , m_height(height)
    , m_steps(steps)
...
{
    float dangle = 360.0 / (float) m_steps;
