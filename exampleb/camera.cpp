...
const float* Camera::scoreboard_mvp_data() const
{
    return m_scoreboard_mvp_matrix.data();
}

const float* Camera::scoreboard_rot_data() const
{
    return m_scoreboard_rot_matrix.data();
}
