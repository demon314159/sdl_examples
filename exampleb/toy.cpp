    ...
    , m_last_launch_action_button(false)
{
    ...
    m_score = new Score(MAX_PLAYERS, SCORE_DIGITS, {BACKGLASS_POSITION_X, BACKGLASS_POSITION_Y, BACKGLASS_POSITION_Z}, {BACKGLASS_SIZE_X, BACKGLASS_SIZE_Z}, TEXTURE_ID_BACKGLASS, TEXTURE_ID_SCORE);
    m_table = new Table();
