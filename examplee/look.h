...
#define HIDE_LEFT_ANIMATION_ID 3.0f
#define HIDE_RIGGHT_ANIMATION_ID 4.0f

#define MARKER_ANIMATION_ID   5.0f
#define BUTTON1_ANIMATION_ID  6.0f
#define BUTTON2_ANIMATION_ID  7.0f
#define BUTTON3_ANIMATION_ID  8.0f
#define BUTTON4_ANIMATION_ID  9.0f
#define BUTTON5_ANIMATION_ID  10.0f
#define BUTTON6_ANIMATION_ID  11.0f
#define BUTTON7_ANIMATION_ID  12.0f
#define BUTTON8_ANIMATION_ID  13.0f
#define BUTTON9_ANIMATION_ID  14.0f
#define BUTTON10_ANIMATION_ID 15.0f
#define BUTTON11_ANIMATION_ID 16.0f
#define TABLE_ANIMATION_ID    17.0f
