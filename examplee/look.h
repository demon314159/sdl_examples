...
#define ROOF_PAINT PaintCan(0.0, 0.8, 0.2)
#define TABLE_PAINT PaintCan(0.4, 0.8, 1.0)

#define DEFAULT_ANIMATION_ID 0.0f
#define LIGHT_ANIMATION_ID   1.0f
#define FIXED_LEFT_ANIMATION_ID   2.0f
#define FIXED_RIGHT_ANIMATION_ID   3.0f
#define HIDE_LEFT_ANIMATION_ID 4.0f
#define HIDE_RIGHT_ANIMATION_ID 5.0f

#define MARKER_ANIMATION_ID   6.0f
#define BUTTON1_ANIMATION_ID  7.0f
#define BUTTON2_ANIMATION_ID  8.0f
#define BUTTON3_ANIMATION_ID  9.0f
#define BUTTON4_ANIMATION_ID  10.0f
#define BUTTON5_ANIMATION_ID  11.0f
#define BUTTON6_ANIMATION_ID  12.0f
#define BUTTON7_ANIMATION_ID  13.0f
#define BUTTON8_ANIMATION_ID  14.0f
#define BUTTON9_ANIMATION_ID  15.0f
#define BUTTON10_ANIMATION_ID 16.0f
#define BUTTON11_ANIMATION_ID 17.0f
#define BUTTON12_ANIMATION_ID 18.0f
#define BUTTON13_ANIMATION_ID 19.0f
#define BUTTON14_ANIMATION_ID 20.0f
#define BUTTON15_ANIMATION_ID 21.0f
#define BUTTON16_ANIMATION_ID 22.0f
#define BUTTON17_ANIMATION_ID 23.0f
#define BUTTON18_ANIMATION_ID 24.0f
#define BUTTON19_ANIMATION_ID 25.0f
#define BUTTON20_ANIMATION_ID 26.0f
#define TABLE_ANIMATION_ID    27.0f
