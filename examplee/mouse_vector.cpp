...
void MouseVector::rotate_az(float deg)
{
    double angle = deg * PI / 180.0;
    Float3 t_org = m_origin;
    Float3 t_vec = m_vector;
    t_org.v1 = m_origin.v1 * cos(angle) - m_origin.v2 * sin(angle);
    t_org.v2 = m_origin.v1 * sin(angle) + m_origin.v2 * cos(angle);
    t_vec.v1 = m_vector.v1 * cos(angle) - m_vector.v2 * sin(angle);
    t_vec.v2 = m_vector.v1 * sin(angle) + m_vector.v2 * cos(angle);
    m_origin = t_org;
    m_vector = t_vec;
}
