    ...
    , m_dimb(dimb)
{
    ...
    FrameModel frame(m_dimx, m_dimy, m_dimz, m_dimb, f_sill, f_head, f_jamb, DOOR_PAINT, animation_id);
    add(frame, 0.0, 0.0, 0.0);
    FrameModel upper_sash(m_dimx - m_dimb, upper_sash_dy, f_thickness, m_dimb, f_stile, f_stile, f_stile, DOOR_PAINT, animation_id);
    add(upper_sash, 0.0, (m_dimy - upper_sash_dy) / 2 - m_dimb, sill_zoffset);
    FrameModel lower_sash(m_dimx - m_dimb, lower_sash_dy, f_thickness, m_dimb, f_stile, f_stile, f_stile, DOOR_PAINT, animation_id);
